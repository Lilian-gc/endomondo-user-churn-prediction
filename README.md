...
| **[Kaggle Source: endomondoHR_subset.json](https://www.kaggle.com/datasets/pypiahmad/endomondo-fitness-trajectories)** | *[Omitted from repo due to GitHub file size limits; download via link]* The original source JSON containing nested high-frequency sensor telemetry (heart rate series, timestamps, and GPS coordinates). |
